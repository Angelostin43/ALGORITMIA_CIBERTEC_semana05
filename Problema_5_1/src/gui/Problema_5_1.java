...
public class Problema_5_1 extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnReportar(ActionEvent arg0) {
    	...
    	imprimir("Cantidad de personas mayores de edad: " + ae.cantMayorEdad());
    	imprimir("Cantidad de personas menores de edad: " + ae.cantMenorEdad());
    	imprimir("Posicion de la primera edad Adolescente: " + ae.posPrimeraEdadAdolescente()); 
    	imprimir("Posicion de la ultima edad Adolescente: " + ae.posUltimaEdadAdolescente());
	}
